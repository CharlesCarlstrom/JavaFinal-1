...
public class GoBack 
{
	...
	public static void goBack(String userName)
	{
		JOptionPane.showMessageDialog(null, "You don't think its best to pull the random lever so you walk back to the chests.");
